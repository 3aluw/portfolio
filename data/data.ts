type techUsed = "TypeScript" | "nuxt" | "contentful" | "Figma" | "deskree" | "convex" | "daisyui" | "materiald" | "Vuetify" | "VueUse" | "swiper" | "openai" 
...
const eCommerceSite: IProject =
{
  ...
  features: [
    ...
    "Dashboard with real-time store statistics",
    "Optimized for fast loading times and smooth navigation",
    "Advanced filtering, categorization, and search capabilities",
...
const leaderboardSite: IProject =
{
  ...
  imageName: "interactive-leaderboard.webp",
  ...
  features: [
    "Easy customization of game settings (participants, winning score, and more)",
    "Colorful and kid-friendly UI design",
    "Immersive funny sounds and playful visual effects",
    "Printable leaderboard to celebrate winners at the end",
    "Real-time score updates and animations",
    "Simple controls so kids and teachers can use it effortlessly"
  ],
  challenges: [
    {
      title: "Sounds",
...
const colorPaletteSite: IProject = {
  ...
  imageName: "color-generator.webp",
  ...
  features: [
    "AI-powered generation of coherent color palettes",
    "Instant preview of palettes applied to a UI kit",
...
const seatingPlannerSite: IProject = {
  ...
  features: [
    "Full plan customization (name, number of attendees, and more)",
    "Drag-and-drop interface for arranging seats",
    "Sorting and grouping capabilities for better organization",
    "Smart seating suggestions based on predefined criteria",
    "Light and dark mode for comfortable use anytime",
    "Download and upload seating plans for easy reuse",
    "Printable version to share or display offline",
  ],
  challenges: [
    {
...
const teacherCalculatorSite: IProject = {
  name: "a calculator for teachers",
  description: "It can help teachers in daunting marks' calculation",
  slug: "teacher-calculator",
  imageName: "teacher-calculator.webp",
  ...
  features: [
    "Very simple and distraction-free UI",
    "Optimized UX for fast calculations without unnecessary clicks",
    "Keyboard-friendly design for quick input",
    "Customizable UI with the option to add or remove buttons",
  ],
  challenges: [
    {
      title: "Challenges",
...
const algExpressSite: IProject = {
  ...
  features: [
    "Straightforward ordering in 3 simple, organized steps",
    "Last ordered section for quick reordering",
    "Product categories to make browsing AliExpress easier",
    "Admin panel to track and update customer orders",
    "User-friendly 'My Orders' interface with tracking capabilities",
    "Telegram bot integration to notify admin of new orders",
  ],
  challenges: [
    {
...
const wisdomWriterSite: IProject = {
  name: "Type Wise",
  description: "An AI-powered typing practice app that delivers fresh phrases daily to make improving speed more fun and immersive.",
  slug: "type-wise",
  imageName: "typewise.webp",
  githubLink: "https://github.com/3aluw/wisdom-writer",
  demoLink: "https://youtu.be/mFmRJPYZi7U",
  techUsed: ["Figma", "convex", "nuxt", "openai"],
  motivation: "Convex organized a hackathon for the best AI app built using their backend. So I participated. The app idea is simple: it helps users increase their typing speed. Unlike many online tools that rely on generic phrases, I wanted to implement AI to create a more engaging and immersive experience by providing users with fresh phrases every day, despite the tight deadline; I managed to create a prototype. The site is closed due to its Ai usage cost, but the code is available",
  features: [
    "Choose the type of phrases you want to practice with",
    "Daily practice sessions to build consistency",
    "Fresh new AI-generated phrases every day",
    "Personalized stats and performance tracking",
  ],
  challenges: [
    {
      title: "Typing Experience Design",
      text: "Designing the typing experience was tricky, especially when implementing the effect of typing over a grey pre-written font. Ensuring it felt smooth and natural required experimentation and fine-tuning."
    }
  ],
  improvements: [
    {
      title: "More Text Variants",
      text: "Expanding the pool of daily phrases to provide users with a wider variety of typing challenges."
    },
    {
      title: "Multilingual Support",
      text: "Adding more languages to make the app accessible to a global audience and enhance inclusivity."
    },
    {
      title: "Typing with Audio",
      text: "Introducing an option for users to type while listening to the text, offering an auditory challenge that further sharpens their typing skills."
    }

  ]
}
export const projects: IProject[] = [algExpressSite, teacherCalculatorSite, leaderboardSite, colorPaletteSite, eCommerceSite, seatingPlannerSite, wisdomWriterSite]